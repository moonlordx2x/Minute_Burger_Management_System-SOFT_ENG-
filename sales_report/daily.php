...
if ($filter == '') {
  ...
  $sql = "SELECT * FROM graph_result where category='$filter' and total !='0' and date_1 = '$time' order by id";
}
            ...
            <li class="dropdown">
             ...
             <li><a href="../casheir/casheir.php"><span class="fa fa-shopping-cart"></span> &nbsp CASHIER</a></a></li>
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                 <li class="active"><a href=""><span class="fa fa-bar-chart-o"></span> &nbsp DAILY SALES REPORT</a>  
 ...
 <!-- 
  ...
  <div class="col-md-12 col-lg-12 col-xs-10 col-sm-10 display-table-cell valign">
    <div class="well col-xs-6 col-md-12 col-lg-12 col-sm-12">
      <h2 class="text-center"><span class="label label-primary fa fa-bar-chart-o"> <b>DAILY SALES REPORT</b></span></h2><br>
...
<?php 
    ...
    if ($filter == '') {
     $sql = "SELECT * FROM minute_sales_report where date_1 = '$time' order by time_1 desc";
    }
    else{
      $sql = "SELECT * FROM minute_sales_report where category = '$filter' and date_1 = '$time' order by time_1 desc";
    }
      $result = mysqli_query($connect,$sql);
 ...
 ?>
    ...
    <div class="col-md-3">
      ...
      <div class="panel panel-primary">
        ...
        <form class="form" action="daily_filter.php" method="POST">

        <div class="panel-body">
          
        
          <label class="text-left">Date Picker :</label><br>
          <input type="date" name="calendar" class="form-control text-left" value="<?=$time?>"><br>
