...
if ($filter == '') {
  $sql = "SELECT * FROM graph_result_week where week_1 = '$week' and week_2 = '$weeks' order by id";
}
else{
  $sql = "SELECT * FROM graph_result_week where category='$filter' and week_1 = '$week' and week_2 = '$weeks' order by id";
}
            ...
            <li class="dropdown">
             ...
             <li><a href="../casheir/casheir.php"><span class="fa fa-shopping-cart"></span> &nbsp CASHIER</a></a></li>
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                 <li><a href="../sales_report/daily.php"><span class="fa fa-bar-chart-o"></span> &nbsp DAILY SALES REPORT</a></li>
                  <li class="active"><a href=""><span class="fa fa-bar-chart-o"></span> &nbsp WEEKLY SALES REPORT</a></li>
                  <li><a href="../sales_report/monthly.php"><span class="fa fa-bar-chart-o"></span> &nbsp MONTHLY SALES REPORT</a></li>                 
                </ul>
            </li> 
 ...
 <!-- 
  ...
  <div class="col-md-12 col-lg-12 col-xs-10 col-sm-10 display-table-cell valign">
    <div class="well col-xs-6 col-md-12 col-lg-12 col-sm-12">
      <h2 class="text-center"><span class="label label-primary fa fa-bar-chart-o"> <b>WEEKLY SALES REPORT</b></span></h2><br>
...
<?php 
    ...
    if ($filter == '') {
     $sql = "SELECT * FROM minute_sales_report where date_1 BETWEEN '$week' and '$weeks' order by time_1 desc";
    }
    else{

      $sql = "SELECT * FROM minute_sales_report where category = '$filter' and date_1 BETWEEN '$week' and '$weeks' order by time_1 desc";
    }
      $result = mysqli_query($connect,$sql);
 ...
 ?>
   ...
   <div class="col-md-3">
      ...
      <div class="panel panel-primary">
        ...
        <form class="form" action="date.php" method="POST">

        <div class="panel-body">
          
        
          <label class="text-left">Date Picker :</label><br>
          <input type="date" name="calendar" class="form-control text-left" value="<?=$week?>">
          <label class="text-center">TO</label>
          <input type="date" name="calendar_1" class="form-control text-left" value="<?=$weeks?>"><br>
