...
if (isset($_POST['minus_submit'])){
	...
	$burger_id = $_POST['minus_id'];
	$burger_name = $_POST['minus_name'];
	$burger_category = $_POST['minus_category'];
	$burger_price = $_POST['minus_price'];

	$burger_bun = $_POST['minus_bun'];
	$burger_patty = $_POST['minus_patty'];
	$burger_dressing = $_POST['minus_dressing'];
	$burger_add_on = $_POST['minus_on_add'];
	$burger_order = $_POST['minus_total'];
	$burger_order_1 = $_POST['minus_total_1'];
	...
	$graph_checking_exist_3 ="SELECT * FROM graph_result_month where name ='$burger_name' and month = '$month'";
		...
		if (mysqli_num_rows($graph_checking_result_3) == 1) {
				while ($graph_checking_row_3 = mysqli_fetch_assoc($graph_checking_result_3)) {
					...
					$graph_query_3 = mysqli_query($connect,$graph_update_total_3);
